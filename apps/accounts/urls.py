...
urlpatterns = [
    ...
    path("mailing/", views.platform_mailing_workspace, name="platform_mailing_workspace"),
    path("mailing/topics/add/", views.platform_mail_template_editor, name="platform_mail_template_add"),
    path("mailing/topics/<int:pk>/edit/", views.platform_mail_template_editor, name="platform_mail_template_edit"),
    path("mailing/campaigns/<int:pk>/dispatch/", views.platform_mail_campaign_dispatch, name="platform_mail_campaign_dispatch"),
    ...
    path("founder/platform/user/add/", views.founder_platform_user_add, name="founder_platform_user_add"),
