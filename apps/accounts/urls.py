...
urlpatterns = [
    ...
    path("founder/subscriptions/mailing-list/contact/", views.founder_mailing_list_contact_action, name="founder_mailing_list_contact_action"),
    path("founder/subscriptions/live-signups/", views.founder_signup_live_snapshot, name="founder_signup_live_snapshot"),
